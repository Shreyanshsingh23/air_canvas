...
# Initialize deques and indices for colors
...
# Canvas setup (black background)
paintWindow = np.zeros((471, 636, 3), dtype=np.uint8)

# Draw color buttons on paintWindow
cv2.rectangle(paintWindow, (40, 1), (140, 65), (255, 255, 255), 2)
...
hand_landmark_style = mpDraw.DrawingSpec(color=(117,117,117), thickness=5)
hand_connection_style = mpDraw.DrawingSpec(color=(255, 255, 255), thickness=2)
...
while True:
    ...
    if result.multi_hand_landmarks:
        for handslms in result.multi_hand_landmarks:
            ...
            mpDraw.draw_landmarks(frame, handslms, mpHands.HAND_CONNECTIONS, hand_landmark_style, hand_connection_style)
